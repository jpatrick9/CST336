<?php
    ...
    foreach($records as $r) {
        ...
        echo            "<input type='hidden' name='pokeIdVal' value='".$r['cardId']."'>";
        echo            "<input type='hidden' name='pokeDescription' value='".$r['description']."'>";
        echo            "<input type='hidden' name='pokeImage' value='".$r['cardImage']."'>";
        echo            "<input type='hidden' name='pokeTypeName' value='".$r['typeName']."'>";
        echo            "<input type='hidden' name='pokeRarity' value='".$r['cardRarity']."'>";
        echo            "<input type='hidden' name='pokePrice' value='".$r['price']."'>";
        echo            "<input type='hidden' name='pokeQuantity' value='".$r['quantityAvailable']."'>";
        echo            "<input id='pokeEditButton' type='submit' value='Edit' class='btn btn-warning' style='position:relative; top:-10px'>";
        echo        "</form>";
        echo        "<form id= 'ygoDeleteForm' action='deleteCard.php' method='post'>";
        echo            "<input type='hidden' name='val' value='".$r['itemName']."'>";
        echo            "<input type='hidden' name='pokeIdVal' value='".$r['cardId']."'>";
        echo            "<input id='pokeDeleteButton' type='submit' value='Delete' class='btn btn-danger' style='position:relative; top:-10px'>";
        echo        "</form>";
        echo    "</details>";
        echo "</div>";
    }
...
<html>
    ...
    <body>
        <h1 class="text-center">Pokemon Card List</h1>

<?php
    if (isset($_POST['addForm'])) {
        ...
        try{
            $sql = "INSERT INTO pokemon (itemName, description, cardImage, typeName, cardRarity)
            VALUES (:itemName, :description, :cardImage, :typeName, :cardRarity)";
